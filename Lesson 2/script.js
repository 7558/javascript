...
function sixthtask() {
    ...
    /*Я не смог сделать обращение из функции к другой функции в функции. Из sixthtask в fithtask к функциям. Так нельзя? */
    alert("Задание №6.")
...
function seventhtask() {
    ...
    alert(a >= b);
    alert(" null >= 0 = true потому что null не больше 0, а значит равняется. Если null не больше и не меньше 0, значит он равняется нулю. Всё логично и довольно интересно.");
}
